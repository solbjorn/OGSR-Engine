...
bool CSoundPlayer::check_sound_legacy(u32 internal_type) const
{
    ...
    {
#ifdef DEBUG
        ai().script_engine().script_log(eLuaMessageTypeMessage, "Can't find sound with internal type {} (sound_script = {})", internal_type,
...
void CSoundPlayer::play(u32 internal_type, u32 max_start_time, u32 min_start_time, u32 max_stop_time, u32 min_stop_time, u32 id)
{
    ...
    {
        XR_LOG_DEBUG("There are no sounds in sound collection \"{}{}\" with internal type {} (sound_script = {})", sound.m_sound_player_prefix,
...
void CSoundPlayer::CSoundCollection::load()
{
    ...
    if (m_sounds.empty())
        XR_LOG_DEBUG("There are no sounds with prefix {}{}", m_params.m_sound_player_prefix, m_params.m_sound_prefix);
}
